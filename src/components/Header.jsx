  ...
  return (
    ...
    <div className="container flex mx-auto p-5 flex-col md:flex-row items-center">
      ...
      <nav className="md:ml-auto text-base">
        <Link to="/"><a href="#homepage" className="mr-5 hover:text-blue-400 duration-300">PickUp</a></Link>
        <Link to="/Interview"><a href="#interview" className="mr-5 hover:text-blue-400 duration-300">Interview</a></Link>
        <Link to="/Review"><a href="#review" className="mr-5 hover:text-blue-400 duration-300">Review</a></Link>
