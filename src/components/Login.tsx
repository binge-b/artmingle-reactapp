...
const Login = () => {
  ...
  return (
    <div className="form-container flex items-center justify-center h-screen bg-gray-200">
        ...
        <h1 className="text-2xl font-bold mb-6 text-center">Log in Form</h1>
        <form onSubmit={handleSubmit(onSubmit)}>
            <label htmlFor="名前" className="block text-sm mb-2">Name</label>
            ...
            <label htmlFor="メールアドレス" className="block text-sm mb-2">Email</label>
            ...
            <label htmlFor="パスワード" className="block text-sm mb-2">Password</label>
